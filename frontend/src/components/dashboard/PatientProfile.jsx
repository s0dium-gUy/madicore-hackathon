...
import { User, Calendar, Clock, Stethoscope, Loader2, X as XIcon, CalendarPlus } from 'lucide-react'
        ...
        {displayPatients.map(p => {
          ...
          return (
            <Card key={p.id}>
              ...
              {isPatient && (
                <div className="border-t border-surface-100 dark:border-dark-border pt-5 space-y-6">
